    ...
    <div className="p-6">
      ...
      <Card className="mb-6">
        ...
        <CardContent className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
          ...
          <Button variant="outline" onClick={() => openModal?.('invoice', entityId) || navigate(`${basePath}/invoices/new`)}>
            <Plus className="h-4 w-4 mr-2" />
            New Invoice
          </Button>
          <Button variant="outline" onClick={() => openModal?.('journalEntry', entityId) || navigate(`${basePath}/journal-entries/new`)}>
            <Plus className="h-4 w-4 mr-2" />
            Journal Entry
          </Button>
